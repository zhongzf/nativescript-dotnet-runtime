...
var Console = (function () {
    ...
    Console.prototype.timeMillis = function () {
        return System.DateTime.Now.Millisecond / 1000000;
    };
        ...
        for (i = 0; i < arrayToLog.length; i++) {
            switch (messageType) {
                case trace.messageType.log: {
                    log("[v]" + this.TAG + arrayToLog[i]);
                    break;
                }
                case trace.messageType.warn: {
                    log("[w]" + this.TAG + arrayToLog[i]);
                    break;
                }
                case trace.messageType.error: {
                    log("[e]" + this.TAG + arrayToLog[i]);
                    break;
                }
                case trace.messageType.info: {
                    log("[i]" + this.TAG + arrayToLog[i]);
                    break;
                }
            }
        }
